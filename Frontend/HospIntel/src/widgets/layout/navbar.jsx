...
export function Navbar({ brandName, routes, action }) {
  ...
  const servicesMenu = (
    <div className="relative">
      ...
      {isServicesOpen && (
        <div className="absolute z-10 mt-2 w-48 rounded-md shadow-lg bg-transparent backdrop-blur-sm ring-1 ring-white/20">
          <div className="py-1" role="menu">
            <Link
              to="/hospital-profiling"
              className="block w-full font-bold text-left px-4 py-2 text-sm text-inherit hover:bg-white/10"
              role="menuitem"
            >
              Hospital Profiling
            </Link>
